...
task 04, that does the following:
  ...
  - Your module has a static variable that points to a list of these
    "identity" structures.
  - Write a function that looks like: `int identity_create(char *name, int id)`
  ...
  - Write a function that looks like: `struct identity *identity_find(int id);`
  ...
  - Write a function that looks like: `void identity_destroy(int id);`
